...
- **Enthusiasm without hype** — confident copy, warm brand tone, energetic but dignified (not salesy)
- **Expertise** — sharp design, real Prishtinë/Kosovo lagjet, EUR pricing, honest m²/rooms data — signals "these people know the market"
- **Authority** — a real agency, not a one-person lister. Logo, stats strip, multiple services, Facebook-validated contact info

### Pain & Urgency (ethical, unconscious level)
Surface — never manipulate — the real costs of going without a trusted agency in Kosovo:
- **Overpaying** on a property because you didn't know the true market comps for the lagje
- **Legal exposure** on title, permits, or contracts that an untrained buyer won't spot
- **Missed investment windows** as Prishtinë neighborhoods appreciate
...
2. **Prove desirability** — Featured Properties grid shows real, aspirational Kosovo listings with pricing and location clarity.
3. **Answer "why you"** — Services (Shitje/Qira/Investime), Rreth Nesh (8+ vite, local ekspertizë), testimonials in Albanian.
4. **Collapse the ask** — Contact section with free-consult framing, form, phone, WhatsApp, zyra on a single screen.
5. **Follow-up (future)** — lead pipeline, WhatsApp automation, SMS drip — mention these as upsell hooks in the pitch conversation, not the demo.

### Copy Guidelines
- **Write in Albanian** — primary language of every Kosovo visitor. Use natural idiomatic Albanian (Kosovan register), not translated-from-English stiff phrasing. Sample voice: *"Partneri juaj i besueshëm për shitje, qira dhe investime — duke krijuar vlerë afatgjatë dhe rezultate të qëndrueshme."*
- **Every word is deliberate** — moves the visitor toward the CTA. Cut adjectives that don't carry weight.
- **Build logic AND emotion** — specific numbers (500+ prona, 8 vite, m², EUR) for logic; vision of the "after" ("shtëpia e ëndrrave," "takohemi për një kafe") for emotion.
- **Speak directly to the qualified visitor** — a Kosovar family buying their first home, a professional signing a qira, an investor building a Prishtinë portfolio. Let the wrong audience self-deselect; don't water down for them.
- **Pre-answer objections** — "prona të verifikuara," "kontrata ligjore," "vlerësim falas," "konsultimi i parë është gjithmonë falas." Every concern the visitor has should be addressed before they ask it.
- **Future-pacing cues in CTAs and microcopy** — not "Submit" but "Dërgo mesazhin," not "Contact us" but "Takohemi për një kafe." The wording should already put them in the scene.
- **Keep English only for universally understood words** (Penthouse, ROI) or for a deliberate trust signal. Default is Albanian.

## Working Style
- Always share the thinking process. For every decision (architecture, sequencing, technology, design, copy), explain transparently: What are the options? What speaks for/against each? Why is the decision made this way? The user wants to understand the reasoning, not just see the result.
...
- Before adding a new section or changing copy, ask: *does this move the visitor closer to a lead, or does it just fill space?* If it doesn't move them on the straight line, cut it or rewrite it.
